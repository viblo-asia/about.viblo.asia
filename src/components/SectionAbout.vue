<template>
    <section id="section-about" class="text-center py-32 flex items-center flex-col md:flex-row">
        <div class="about-image md:order-last w-full md:w-1/2">
            <img src="../assets/viblo app.svg" alt="section about" class="m-auto" />
        </div>
        <div class="about-content px-16 md:py-16 md:order-first w-full md:w-1/2">
            <div class="px-8 md:py-8 md:transform">
