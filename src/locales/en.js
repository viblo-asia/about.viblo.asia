const en = {
  ...
  sectionAbout: {
    citation1: 'is a growing community of knowledge sharing and learning about information technology with more than 80000 active users; Managed and developed by Viblo Team.',
    citation2: {
      title: 'With the foundation of service',
      intro: 'launched on April 3, 2015, you can write and share article related to technical issues such as:',
    ...
    citation3: {
      ...
      ctf: '(service for practicing coding skills, Information Assurance) and',
